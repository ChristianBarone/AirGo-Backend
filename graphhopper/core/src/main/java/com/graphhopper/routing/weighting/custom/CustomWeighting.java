...
import com.graphhopper.routing.util.PollutionService;
...
public final class CustomWeighting implements Weighting {
     ...
     */
    private final DecimalEncodedValue pollutionEnc;
    ...
    public CustomWeighting(DecimalEncodedValue pollutionEnc, TurnCostProvider turnCostProvider, Parameters parameters) {
        this.pollutionEnc = pollutionEnc;
    ...
    public double calcEdgeWeight(EdgeIteratorState edgeState, boolean reverse) {
        ...
        double pollutionValue = edgeState.get(pollutionEnc);

        // Aplicamos una penalización (ajusta el factor a tu gusto)
        // Si pollutionValue es 1.0 (máxima polución), la prioridad baja drásticamente.
        double pollutionPenalty = 1.0 - (pollutionValue * 0.8);
        double finalPriority = priority * pollutionPenalty;
